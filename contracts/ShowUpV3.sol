...
contract ShowUpV3 is ReentrancyGuard {
        ...
        eventActive(eventId)
    {
        ...
        reservation.status =
            ReservationStatus.PaymentDefaulted;
    ...
    function _confirmAttendance(
        ...
        reservation.paymentDeadline = uint64(
            block.timestamp + PAYMENT_GRACE_PERIOD
        );
