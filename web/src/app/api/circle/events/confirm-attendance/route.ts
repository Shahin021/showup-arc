  ...
  try {
    ...
    if (
      ...
      throw new ShowUpApiError(
        "Only the event organizer can confirm attendance.",
        403,
      );
    }
    ...
    if (
      ...
      throw new ShowUpApiError(
        "Attendance cannot be confirmed for a cancelled event.",
      );
    }
    ...
    if (
      ...
      throw new ShowUpApiError(
        "The attendance confirmation window is closed.",
      );
    }
    ...
    const challenge =
      await createCircleChallenge({
        ...
        abiFunctionSignature:
          "confirmAttendance(uint256,address)",
        abiParameters: [
          eventId.toString(),
          attendee,
        ],
    ...
    console.error(
      "ShowUp attendance confirmation challenge failed:",
      error,
    );
